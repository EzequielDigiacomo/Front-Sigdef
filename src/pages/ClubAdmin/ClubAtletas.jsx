    ...
    const fetchAtletas = async () => {
        try {
            ...
            setErrorModal({
                isOpen: true,
                title: 'Error',
                message: 'No se pudieron cargar los atletas. Por favor, intenta nuevamente más tarde.'
            });
        } finally {
            setLoading(false);
        }
    ...
    const handleConfirmDelete = async () => {
        ...
        try {
            ...
            setErrorModal({
                ...
                message: 'Hubo un problema al intentar eliminar el atleta. Verifica tu conexión o intenta nuevamente.'
            });
        }
    };
    ...
    return (
        <div className="club-atletas">
            ...
            <ConfirmationModal
                ...
                message={`¿Estás seguro de que deseas eliminar a ${atletaToDelete?.nombrePersona || 'este atleta'}? Esta acción no se puede deshacer.`}
