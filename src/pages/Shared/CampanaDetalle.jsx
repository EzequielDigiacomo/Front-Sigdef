        ...
        <div className="campana-detalle">
            ...
            <div className="campana-detalle-header">
                ...
                <p>
                    ...
                    {pickNum(campana, 'cantidadDestinatarios', 'CantidadDestinatarios') ||
                        hilos.length}{' '}
                    destinatarios
                </p>
            ...
            <div className="campana-cuerpo">
                ...
                <small>
                    Cada destinatario responde en su hilo privado (no es un chat grupal).
                </small>
            </div>
                ...
                {hilos.map((hilo) => {
                    ...
                    return (
                        <div key={hiloId} className="campana-hilos-row">
                            <div>
                                <strong>
                                    {pickStr(hilo, 'destinatarioNombre', 'DestinatarioNombre')}
                                </strong>
                                <small>
                                    {' '}
                                    @{pickStr(hilo, 'destinatarioUsername', 'DestinatarioUsername')}
                                </small>
                            </div>
                            <div className="campana-estado">
                                ...
                                {respondido && (
                                    <span className="ok">
                                        <MessageSquare size={14} /> Respondió
                                    </span>
                                )}
                            </div>
                            <Button
