...
export default function HomeContacto({ nivelInteres, setNivelInteres }) {
  return (
    <section className="contacto-section" id="contacto">
      <div className="home-container">
        <div className="contacto-title-wrapper">
          <h2>
            Ponete en <span>Contacto</span>
          </h2>
        ...
        <div className="contacto-grid">
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            ...
            <div style={{ display: 'flex', gap: '0.75rem' }}>
              <a
                href="https://wa.me/5493412280901?text=Hola%20SIGDEF%2C%20quiero%20conocer%20más%20sobre%20sus%20servicios"
                target="_blank"
                rel="noopener noreferrer"
                className="btn-acc-green"
                style={{ flex: 1, padding: '0.75rem 1rem !important', fontSize: '0.925rem' }}
              >
                <MessageSquare size={16} /> WhatsApp
              </a>
              <a href="mailto:info@sigdef.com.ar" className="btn-acc-outline" style={{ flex: 1, padding: '0.75rem 1rem !important', fontSize: '0.925rem' }}>
                <Mail size={16} /> Email
              </a>
            </div>
          </div>
                ...
                >
                  ...
                  <optgroup label="🎁 Pack Dúo (Ecosistema Integrado)" style={{ background: '#0b0f19', color: '#ffffff', fontWeight: 600 }}>
                    <option value="Pack Dúo - Plan Esencial" style={{ background: '#0b0f19', color: '#cbd5e1' }}>
                      Pack Dúo — Plan Esencial (Hasta 500 atletas)
                    </option>
                    <option value="Pack Dúo - Plan Profesional" style={{ background: '#0b0f19', color: '#cbd5e1' }}>
                      Pack Dúo — Plan Profesional (501 a 2,000 atletas)
                    </option>
                    <option value="Pack Dúo - Plan Ecosistema" style={{ background: '#0b0f19', color: '#cbd5e1' }}>
                      Pack Dúo — Plan Ecosistema (Más de 2,000 atletas)
                    </option>
                  </optgroup>
                  <optgroup label="🟢 Solo SIGDEF (Gestión)" style={{ background: '#0b0f19', color: '#ffffff', fontWeight: 600 }}>
                    <option value="Solo SIGDEF - Plan Esencial" style={{ background: '#0b0f19', color: '#cbd5e1' }}>
                      Solo SIGDEF — Plan Esencial (Hasta 500 atletas)
                    </option>
                    <option value="Solo SIGDEF - Plan Profesional" style={{ background: '#0b0f19', color: '#cbd5e1' }}>
                      Solo SIGDEF — Plan Profesional (501 a 2,000 atletas)
                    </option>
                    <option value="Solo SIGDEF - Plan Ecosistema" style={{ background: '#0b0f19', color: '#cbd5e1' }}>
                      Solo SIGDEF — Plan Ecosistema (Más de 2,000 atletas)
                    </option>
                  </optgroup>
                </select>
              </div>
